...
export default function RetailSigns() {
    const images = [
  { src: "/asset/picture/rs-101.png", alt: "Slide 1" },
  { src: "/asset/picture/rs-102.png", alt: "Slide 2" },
  { src: "/asset/picture/rs-103.png", alt: "Slide 3" },
  { src: "/asset/picture/rs-104.png", alt: "Slide 4" },
  { src: "/asset/picture/rs-105.png", alt: "Slide 5" },
  { src: "/asset/picture/rs-106.png", alt: "Slide 6" },
];
// galary data
  return (
    <div>
